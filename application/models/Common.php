...
public function getbypaginationslider($tbl,$start,$perPage)
{
 ...
 public function getchild($id)
   ...
   public function getsize($whr)
   {
    ...
    public function allorder($start,$perPage)
    {
      $this->db->select('o.*,u.*');
      $this->db->from('orders as o');
      $this->db->join('users as u','u.userId = o.userId');
      $this->db->limit($perPage,$start);
    ...
    public function singleorder($where)
    {
      $this->db->select('o.*,u.*');
      $this->db->from('orders as o');
      $this->db->join('users as u','u.userId = o.userId');
    ...
    {
      $this->db->select('i.*,v.*');
      $this->db->from('order_item as i');
      $this->db->join('variation as v','v.variationId = i.variationId');
      $this->db->where($where);
      $result = $this->db->get();
      $result = $result->result();
      return $result;
    ...
    public function getItemPdf($where)
    {
      $this->db->select('i.*,v.*');
      $this->db->from('order_item as i');
      $this->db->join('variation as v','v.variationId = i.variationId');
      $this->db->where_in('orderId',$where);
      $result = $this->db->get();
      $result = $result->result();
      return $result;
    }

    public function getUserCategory($where)
    {
      $this->db->select('i.*,v.*');
      $this->db->from('user as u');
      $this->db->join('variation as v','v.variationId = u.variationId');
      $this->db->where($where);
      $result = $this->db->get();
      $result = $result->result();
      return $result;
