		...
		<main id="main">
			<div class="login-block d-lg-flex">
				...
				<div class="holder bg-yellow d-flex align-items-center justify-content-center">
					<form action="<?php echo base_url(); ?>forgotSubmit" method="post" class="form reset" id="forgotform">
						<div class="login-form-holder">
							<div class="fields-holder">
								...
								<a href="<?php echo base_url(); ?>" style="text-decoration: underline; 	"><p style="color: #454545; position: relative; top: 20px;">Login</p></a>
