				...
				<div class="holder d-flex align-items-center">
					...
					<div class="signup-holder">
						...
						<div class="text-holder">
							...
							<p>New here? <a href="<?php echo base_url(); ?>login">login</a></p>
						</div>
					</div>
				</div>
				<div class="holder bg-yellow d-flex align-items-center justify-content-center">
					<form action="<?php echo base_url(); ?>signupSubmit" method="post" class="form reset" id="signupform">
							...
							<div class="fields-holder">
								...
								<div class="input-wrap">
									<div class="input-holder">
										...
										<label for="email" class="label-txt">Name</label>
										<input id="name" type="text" name="name" class="form-control" placeholder="Please enter name">
									</div>
								</div>
								<div class="input-wrap">
									<div class="input-holder">
										<label for="email" class="ico icon-mail"></label>
										<label for="email" class="label-txt">Phone</label>
										<input id="phone" type="text" name="phone" class="form-control" placeholder="Please enter phone">
									</div>
								</div>
								<div class="input-wrap">
									<div class="input-holder">
								...
								<div class="input-wrap">
									<div class="input-holder switch-state">
										<label for="password-field" class="label-txt">Confirm Password</label>
						...
						<div class="quick-form-holder">
							...
							<div class="input-wrap">
								<div class="input-holder">
									<input id="company" type="text" class="form-control style" placeholder="">
									<label for="company" class="label-txt style">Company Name</label>
								</div>
							</div>
							<div class="input-wrap">
								<div class="input-holder">
									<input id="c-email" type="email" class="form-control style" placeholder="">
									<label for="c-email" class="label-txt style">Company Email </label>
								</div>
							</div>
							<div class="textarea-holder">
								<textarea  cols="25" rows="10" placeholder="Type here…" class="form-control"></textarea>
							...
							<div class="input-wrap">
								<div class="input-holder">
									<input id="my-name" type="text" class="form-control style" placeholder="">
									<label for="my-name" class="label-txt style">My Name (Optional)</label>
								</div>
							</div>
							<div class="input-wrap">
								<div class="input-holder">
									<input id="my-email" type="email" class="form-control style" placeholder="">
									<label for="my-email" class="label-txt style">My Email (Optional)</label>
								</div>
							</div>
							<div class="input-wrap">
								<button class="btn btn-dark w-100" data-toggle="modal" data-target="#exampleModal-1">That's it.. SUBMIT!</button>
							</div>
